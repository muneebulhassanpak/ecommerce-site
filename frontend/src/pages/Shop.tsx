          ...
          <div className="grid grid-cols-12">
            <div className="col-span-12 md:col-span-3 w-full max-md:max-w-md max-md:mx-auto">
              ...
              <div className="mt-7 box rounded-xl border border-gray-300 bg-white p-6 w-full md:max-w-sm">
                      ...
                      >
                        <div className="box flex flex-col gap-2 mt-5">
                          <div className="flex items-center mb-2">
                            ...
                            />
                            <label className="ml-1 font-normal text-xs cursor-pointer  text-gray-600">
                              option-1
                            </label>
                          </div>
                          <div className="flex items-center mb-2">
                ...
                <label className="font-medium text-sm leading-6 text-gray-600 mb-1">
                  Offer
                </label>
            ...
            <div className="col-span-12 md:col-span-9">
              <div className="mx-auto w-full max-w-5xl px-4 py-16 sm:px-6  lg:max-w-7xl lg:px-8">
